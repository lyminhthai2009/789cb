...
function regPhone(client, data, redT, id, contact){
...
module.exports = function(client, data, redT, id, contact) {
	if (!!data.regPhone) {
		regPhone(client, data.regPhone);
		UserInfo.findOneAndUpdate({id:check1.uid}, {$set:{veryphone:true,veryold:true}});
	}
